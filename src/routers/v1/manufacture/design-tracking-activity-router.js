const Manager = require("bateeq-module").manufacture.DesignTrackingActivityManager;
...
const PkgCloudHelper = require('../../../pkg-cloud-helper');
const db = require("../../../db");
...
function getRouter() {
                ...
                PkgCloudHelper.getStorageClient()
                    .then((storageClient) => {
                        ...
                        for (var i = 0; i < property.length; i++) {
                            ...
                            uploadFileProcess.push(uploadHelper.uploadFile(files[property[i]], storageClient, "bateeq-design-tracking"));
                        }
    ...
    router.get('/attachment/:fileName', (request, response, next, res) => {
        ...
        PkgCloudHelper.download("bateeq-design-tracking", fileName, function (download) {
    ...
    router.put("/activity/updateAttachment", passport, (request, response, next) => {
        ...
        db.get()
            ...
            .then((result) => {
                PkgCloudHelper.delete("bateeq-design-tracking", data.fileName, function (err) {
                    if (!err) {
